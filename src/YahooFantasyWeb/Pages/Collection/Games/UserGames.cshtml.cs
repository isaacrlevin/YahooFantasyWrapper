...
{
    public class CollectionGamesUserGamesModel : PageModel
    {
        private readonly IYahooAuthClient _authClient;
        private readonly IYahooFantasyClient _fantasyClient;

        public CollectionGamesUserGamesModel(IYahooAuthClient authClient, IYahooFantasyClient fantasyClient)
        {
