...
{
    public class ResourceGamePositionTypesModel : PageModel
    {
        private readonly IYahooAuthClient _authClient;
        private readonly IYahooFantasyClient _fantasyClient;

        public ResourceGamePositionTypesModel(IYahooAuthClient authClient, IYahooFantasyClient fantasyClient)
        {
