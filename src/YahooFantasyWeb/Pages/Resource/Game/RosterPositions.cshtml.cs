...
{
    public class ResourceGameRosterPositionsModel : PageModel
    {
        private readonly IYahooAuthClient _authClient;
        private readonly IYahooFantasyClient _fantasyClient;

        public ResourceGameRosterPositionsModel(IYahooAuthClient authClient, IYahooFantasyClient fantasyClient)
        {
