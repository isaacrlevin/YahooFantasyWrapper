...
{
    public class ResourceGameStatCategoriesModel : PageModel
    {
        private readonly IYahooAuthClient _authClient;
        private readonly IYahooFantasyClient _fantasyClient;

        public ResourceGameStatCategoriesModel(IYahooAuthClient authClient, IYahooFantasyClient fantasyClient)
        {
